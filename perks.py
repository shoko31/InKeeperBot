...
class PerksClass:
    ...
    def __init__(self):
        ...
        self.groups = {
            'group.admin': ['cmd.afk', 'cmd.stopafk', 'cmd.help', 'cmd.commands', 'cmd.perm', 'cmd.prefix', 'cmd.warn', 'cmd.warns', 'cmd.mute', 'cmd.unmute'],
            'group.moderator': ['cmd.afk', 'cmd.stopafk', 'cmd.help', 'cmd.commands', 'cmd.prefix.display', 'cmd.warn', 'cmd.warns', 'cmd.mute', 'cmd.unmute'],
